...
class EnvironmentLLMWorker(Worker):
    ...
    def init_model(self):
        ...
        cpu_offload = CPUOffload(offload_params=True) if self._is_offload_param else None
    ...
    def _init_vllm_engine(self, local_path, model_config):
        try:
            ...
            # Patient simulation and reward scoring only consume generated text.
            # Avoid allocating large vocabulary-sized tensors for unused log probabilities.
            self.vllm_engine.sampling_params.logprobs = None
            self.vllm_engine.sampling_params.prompt_logprobs = None
