...
class BaseDiscreteActionEnv(BaseEnv, ABC):
    ...
    This class provides common functionality for environments with discrete actions.
    """
...
class BaseLanguageBasedEnv(BaseEnv, ABC):
    ...
    This class provides common functionality for language-based environments.
    """
